...
*The Received waveform shows a different framing protocol consisting of a Preamble, Counter Reset, and color data only.*

The signal waveform shows a received frame. The long bits are represented as a 1 while the short bits are represented as a 0.
